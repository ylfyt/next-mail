		...
		<IonPage>
			<IonContent fullscreen>
				<div className="h-full flex flex-col items-center text-black md:justify-center md:w-1/2 md:mx-auto">
					...
					<div className="font-bold text-2xl mb-2 mt-10 md:mt-4">Register</div>
					<div className="flex flex-col w-full px-4 items-center mb-10">
						...
						<LoadingButton loading={loading} disabled={!email || !password} onClick={register} className="bg-blue-500 w-[100px] min-h-[35px] rounded-lg text-white">
							Submit
						</LoadingButton>
					</div>
					<div className="flex">
